...
class CreateLeaveRequestPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocListener<LeaveRequestCubit, LeaveRequestState>(
          ...
          child: BlocBuilder<LeaveRequestCubit, LeaveRequestState>(
            builder: (context, state) {
              ...
              } else if (state is LeaveRequestInitial ||
                  state is LeaveRequestLoading) {
                return const Center(
        ...
        Container(
          ...
          child: DropdownButtonFormField<UserEntity>(
            ...
            onChanged: (UserEntity? manager) {
              if (manager != null) {
                context.read<LeaveRequestCubit>().selectManager(manager);
              }
            },
  ...
  Future<void> _selectStartDate(BuildContext context) async {
    ...
    if (picked != null && context.mounted) {
      context.read<LeaveRequestCubit>().updateStartDate(picked);
    }
  }
  ...
  Future<void> _selectEndDate(BuildContext context) async {
    ...
    if (picked != null && context.mounted) {
      context.read<LeaveRequestCubit>().updateEndDate(picked);
    }
  }
  ...
  Future<void> _selectStartTime(BuildContext context) async {
    ...
    if (picked != null && context.mounted) {
      context.read<LeaveRequestCubit>().updateStartTime(picked);
    }
  }
  ...
  Future<void> _selectEndTime(BuildContext context) async {
    ...
    if (picked != null && context.mounted) {
      context.read<LeaveRequestCubit>().updateEndTime(picked);
    }
  }
}
